...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-4.mt-5(data-aos="zoom-in-left")
      .col-sm-12.col-md-3.col-lg-3.mb-5.mb-sm-0
    ...
    .tarjeta.tarjeta--azul.p-4.mb-4.borde-redondo.mt-5.mb-5(style="background-color: #F8F5FF")(data-aos="zoom-in-left")
      SlyderA(tipo="b")
        .row.justify-content-center.my-lg-4
          .col-md-6.mb-4.mb-md-0
            p.p-4 1. En la barra de menú #[b vista] seleccione la opción #[b caja de herramientas] y active la ventana de #[b herramientas], ubicada al lado izquierdo de la pantalla.
            p.p-4 2. Otra manera de visualizar las herramientas es #[b situar el cursor debajo de la barra de menú], y con clic derecho observar las que están disponibles.
            p.p-4 De igual manera, se pueden activar las herramientas que se necesitan y dejar inactivas las que no se estén utilizando en el momento.
          .col-md-6
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta1/imagen1.svg", alt='La imagen presenta dos capturas de pantalla de la interfaz de un programa de diseño de patrones. En la parte superior, se detalla un menú desplegable seleccionado desde la barra de menú, mostrando opciones de configuración. En la parte inferior, se expone un submenú desplegado que ofrece varias opciones adicionales, posiblemente relacionadas con herramientas específicas del diseño. Ambos menús están resaltados con un óvalo negro.')
        .row.justify-content-center.my-lg-4
      ...
      LineaTiempoC.color-acento-botones(text-small)
        ...
        .row(titulo="2")
          .col-md-5.mb-4.mb-md-0
            ...
            ol.lista-ol--cuadro.ps-5.mb-0.fa-ol
              li 
                .lista-ol--cuadro__vineta
                  span 1
                | Colores.
              li 
                .lista-ol--cuadro__vineta
                  span 2
                | Activar o desactivar relleno de la pieza.
              li 
                .lista-ol--cuadro__vineta
                  span 3
                | Activar ventanas de diálogo de las herramientas.
              li 
                .lista-ol--cuadro__vineta
                  span 4
                | Unidades de trabajo (unidades de medida).
              li 
                .lista-ol--cuadro__vineta
                  span 5
          ...
          .col-md-5.mb-4.mb-md-0
            ...
            ol.lista-ol--cuadro.fa-ol.ps-5
              li 
                .lista-ol--cuadro__vineta
                  span 1
                | Color del relleno de las piezas.
              li 
                .lista-ol--cuadro__vineta
                  span 2
    ...
    .tarjeta.tarjeta--gris.p-4.borde-redondo.mt-5(style="background-color: #F8F5FF")(data-aos="zoom-in-left")
      LineaTiempoC.color-acento-botones(text-small)
        .row(titulo="1")
          .col-md-5.mb-4.mb-md-0
          ...
          .col-md-5.mb-4.mb-md-0
            ...
            ul.lista-ul--color.fa-ul.color-primario.ps-5
              li 
                i.fas.fa-plus
                span.mb-0 #[b Altura de cadera:] según talla (talla 10 = 18 cm).
            p.ps-5 Sobre la línea de cintura, marcar:
            ul.lista-ul--color.fa-ul.color-primario.ps-5
              li 
                i.fas.fa-plus
                span.mb-0 #[b Cintura:] ¼ de contorno de cintura + pinza.
    ...
    p.mb-5.mt-5 #[b Parte posterior talla 10. ]

    AcordionA(tipo="b" clase-tarjeta="tarjeta tarjeta--purple")(data-aos="zoom-in-left")
      .row.borde-redondo-tmorada(titulo="Paso 1")
        .col-md-4.mb-4.mb-md-0
          p.p-5 Inicie creando un archivo nuevo, sobre el archivo cree un rectángulo con las siguientes medidas:
          ul.lista-ul--color.fa-ul.color-primario.ps-5
              li 
                i.fas.fa-plus
        ...
        .col-md-8
          img.p-5(src="@/assets/curso/temas/tema1/tarjeta5/imagen1.svg", alt='La imagen detalla un patrón de costura con varias medidas y etiquetas. En el lado izquierdo, se presenta una línea vertical con una etiqueta en el centro. A la derecha, se expone un esquema con medidas específicas: “Medida de Hombro,” “Medida de Escote,” “Caída de Hombro,” y “Medida Centro Atrás.” También se indican instrucciones para ajustar el patrón, como “Mitad de la distancia A-D” y “Bajar Punto B 2 cms.” Las letras A, B, C, D, E, F, y H marcan puntos clave en el patrón.')
      .row.borde-redondo-tmorada(titulo="Paso 2")
        .col-md-4.mb-4.mb-md-0
          p.p-5 Haga doble clic sobre el #[b ángulo del escote ] y cambie el atributo del punto, #[b desmarcando escalado y señalando curva. ]
        .col-md-8
          img.p-5(src="@/assets/curso/temas/tema1/tarjeta5/imagen2.svg", alt='La imagen presenta un cuadro de diálogo titulado “Atributos de Punto” en un software de diseño de patrones. Las opciones permiten seleccionar el tipo de punto, con casillas de verificación para “Escalado” y “Curva,” siendo “Curva” la opción seleccionada. Se puede ajustar el “Ángulo del punto” (con el valor 180) y el “Nombre del punto.” Hay botones para “Aplicar,” “Cancelar,” y “Costura.”')
      .row.borde-redondo-tmorada(titulo="Paso 3")
        .col-md-4.mb-4.mb-md-0
          p.p-5 Los ángulos del hombro y continuación de la sisa se suprimen. El patrón queda como lo señala la imagen.
        .col-md-8
          img.p-5(src="@/assets/curso/temas/tema1/tarjeta5/imagen3.svg", alt='La imagen presenta tres piezas de patrón de costura alineadas horizontalmente. Cada pieza tiene una línea central vertical y varias líneas horizontales y curvas en la parte superior que indican diferentes medidas y ajustes. Las piezas parecen representar diferentes etapas de modificación de un mismo patrón.')
      .row.borde-redondo-tmorada(titulo="Paso 4")
        .col-md-4.mb-4.mb-md-0
          p.p-5 Con la herramienta #[b medir ] se señala el segmento del hombro en el sentido de las manecillas del reloj. Haga clic en el botón #[b editar largo del segmento]; este a su vez abre la ventana largo del segmento.
          p.ps-5 En la ventana editar largo del segmento, escribir 12 cm para el largo y escoja la opción #[b primer horizontal]. Esta opción se selecciona porque el punto correspondiente al ángulo del hombro sisa es el que debe moverse al realizar el cambio de medida, y elija primer horizontal porque es el punto inicial.
        .col-md-8
          img.p-5(src="@/assets/curso/temas/tema1/tarjeta5/imagen4.svg", alt='La imagen detalla un patrón de costura a la izquierda con una línea central vertical y varias líneas de control en los bordes. A la derecha, hay dos cuadros de diálogo. El primero es la “Ventana de medidas,” que incluye opciones para editar la longitud del segmento, con el botón “Editar largo del segmento” resaltado. El segundo cuadro de diálogo, titulado “Largo del segmento,” permite ajustar la longitud de un segmento específico, con opciones para aceptar, cancelar y copiar/pegar. Elementos como “Nuevo,” “Punto vertical,” y “Uso horizontal” están resaltados. ')
      .row.borde-redondo-tmorada(titulo="Paso 5")
        .col-md-4.mb-4.mb-md-0
          p.p-5 Ubique el punto mitad de sisa (mitad de la distancia entre el escote y altura de sisa), y marque también sobre la línea donde formará la curva de sisa.
        .col-md-8
      ...
      .row.borde-redondo-tmorada(titulo="Paso 7")
        .col-md-4.mb-4.mb-md-0
          p.p-5 #[b Dele la forma ] a la sisa siguiendo las indicaciones de las imágenes.
        .col-md-8
    ...
    .tarjeta.tarjeta--gris.p-4.borde-redondo(style="background-color: #F8F5FF")(data-aos="zoom-in-left")
      LineaTiempoC.color-acento-botones(text-small)
        .row(titulo="1")
          .col-md-5.mb-4.mb-md-0
        ...
        .row(titulo="2")
          .col-md-5.mb-4.mb-md-0
            p.ps-5 #[b 2. ] Trace líneas guías sobre la caída y la medida de hombro. Eleve el ángulo superior derecho del rectángulo a la intersección de las líneas guías. Para ello, se utiliza la herramienta #[b mover punto]. Haga clic sobre el punto del ángulo superior izquierdo del rectángulo, cambiar el atributo de escalado a curva y modele la curva de escote con la herramienta #[b mover punto].
          .col-md-7
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta7/imagen2.svg", alt='La imagen expone el diseño de un patrón de costura enfocado en la medida del escote y del hombro. A la izquierda, se indican las medidas del escote y del hombro con flechas rojas en la parte superior del rectángulo, junto con una flecha adicional que señala la “Caída de Hombro”. A la derecha, se presenta el patrón ajustado con una línea curva que representa la caída del hombro, y líneas punteadas azules que indican las guías para las medidas del escote y el hombro. Este diagrama explican cómo tomar y aplicar estas medidas en el patrón de una prenda.')
        .row(titulo="3")
          .col-md-5.mb-4.mb-md-0
            p.ps-5 #[b 3. ] Trace la curva de escote utilizando la herramienta #[b punto en contorno]. Suprima los puntos de la imagen anterior para definir la línea de hombro y línea de sisa. Se puede tomar como referencia las #[b líneas guías].
          .col-md-7
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta7/imagen3.svg", alt='La imagen presenta un patrón de costura con líneas y puntos que indican las medidas y ajustes para el escote y el hombro. Las líneas punteadas azules representan guías de referencia para estas medidas. La línea curva en la parte superior izquierda indica el escote, mientras que las líneas inclinadas y rectas a la derecha muestran la caída y la posición del hombro. Este patrón expone cómo aplicar las medidas del escote y el hombro en el diseño de una prenda. ')
        .row(titulo="4")
          .col-md-5.mb-4.mb-md-0
            p.ps-5 #[b 4. ] Seleccione la línea de hombro en #[b sentido de las manecillas del reloj]. Haga clic en el botón #[b editar largo del segmento]; en esta ventana se escribe #[b el valor a editar] que para la talla 10 corresponde a 12 cm, también seleccione la opción #[b última horizontal], según la posición de la gráfica. Al escoger esta opción se debe tener en cuenta que el punto a mover para ajustar la medida debe ser el #[b punto hombro-sisa. ]
          .col-md-7
        ...
        .row(titulo="6")
          .col-md-5.mb-4.mb-md-0
            p.ps-5 #[b 6. ] Ubique el punto de #[b altura de pecho]. Para ello, se utiliza la herramienta #[b punto en contorno ] y la #[b opción proporcional 0,5]. Seleccione el atributo de escalado. La ubicación de este punto se marca también sobre la línea de sisa.
          .col-md-7
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta7/imagen6.svg", alt='La imagen detalla una ventana de “Atributos de Punto” del software de diseño de patrones de costura junto a un patrón de prenda. En la ventana, se pueden configurar los atributos del punto, como el tipo de punto (Curva o Escalado), coordenadas X e Y, distancia, ángulo, y la opción de mover sobre el contorno. También se destacan los valores de posición absoluta y proporcional del punto. A la derecha, el patrón presenta el punto ajustado en el diseño de la prenda, con líneas y puntos que indican las medidas y ajustes específicos. ')
        .row(titulo="7")
          .col-md-5.mb-4.mb-md-0
            p.ps-5 #[b 7. ] Con la herramienta #[b mover punto]; corra el punto a la distancia que resulte de la resta de la medida que dio entre los dos puntos y la medida de mitad de ancho de pecho, según la talla que se esté trazando.
          .col-md-7
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta7/imagen7.svg", alt='La imagen presenta dos diagramas de patrones de costura. En el diagrama superior, se indican dos puntos específicos con círculos rojos, entre los cuales se mide la distancia utilizando la herramienta “Medida”. El texto entre los puntos dice: “Medimos la distancia entre estos puntos, con la herramienta ‘Medida’”. En el diagrama inferior, se presenta un patrón de prenda con las medidas y ajustes aplicados, reflejando la modificación basada en la distancia medida entre los dos puntos en el diagrama superior. ')
        .row(titulo="8")
          .col-md-5.mb-4.mb-md-0
            p.ps-5 #[b 8. ] Trace la curva de la sisa e identifique el punto de vértice de pinza.
          .col-md-7
        ...
        .row(titulo="10")
          .col-md-5.mb-4.mb-md-0
            p.ps-5 #[b 10. ] El patrón debe quedar según la ilustración.
          .col-md-7
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta7/imagen10.svg", alt='La imagen expone una ventana emergente de un software de diseño de patrones de costura. La ventana emergente está titulada “ventana piezas” y ofrece opciones para editar una pieza del patrón. El menú desplegable presenta las opciones “Editar”, “Pieza”, y “Borrar”. Bajo la opción “Pieza”, se pueden elegir las subopciones “Reemplazar Original”, “Remover Actual” y “Crear como nueva”. En el fondo, se identitica parte de un patrón de costura y una regla de medición, lo que sugiere que el usuario está trabajando en ajustar o modificar el diseño del patrón. ')
        .row(titulo="11")
          .col-md-5.mb-4.mb-md-0
            p.ps-5 #[b 11. ] Corregir el sentido de hilo de la tela con la herramienta #[b hilo paralelo al tramo.] Centre y aplome con la herramienta #[b nueva línea base.] Por último, actualizar los cambios en la ventana de piezas, con la opción #[b reemplazar original.]
          .col-md-7
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta7/imagen11.svg", alt='La imagen presenta un patrón de costura para la parte delantera de una prenda, como una camisa o blusa. Incluye las líneas de contorno para los bordes, puntos de referencia importantes (marcados en rosa y negro), y líneas de construcción para guiar el corte y la costura. La “Base Delantero” es una línea vertical utilizada como referencia. Las curvas en la parte superior representan el escote y la sisa, esenciales para el ajuste de la prenda. El patrón guía el corte y ensamblaje de la tela para asegurar un ajuste correcto y la forma deseada. ')

    .row.justify-content-center.mt-2(data-aos="zoom-in-left")
      .col-sm-12.col-lg-6
        .tarjeta.borde-redondo.p-4.mb-5(style='background-color: #673AB7')
          .row.justify-content-around.align-items-center
            .col-sm-12.col-lg-2.d-none.d-lg-block
    ...
    .tarjeta.tarjeta--azul.p-4.mb-4.borde-redondo(style="background-color: #F8F5FF")(data-aos="zoom-in-left")
      SlyderA(tipo="b")
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 1. ] Para dar inicio se parte de la base superior delantera, trace una línea guía hasta la línea de cintura o largo de talle delantero.
          .col-md-8
        ...
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 3. ] Valide que la línea de cintura esté #[b totalmente recta] sobre la línea de talle delantero, y verifique con la #[b tecla F8] qué medida tiene la cintura.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta8/imagen3.svg", alt='La imagen presenta dos patrones de costura: uno para la parte delantera (izquierda) y otro para la parte trasera (derecha) de una prenda. El patrón delantero está marcado como “Base SUPERIOR FRENTE” y está coloreado en azul, mientras que el trasero está marcado como “Base SUPERIOR ESPALDA”. Ambos patrones incluyen puntos de referencia en rosa y medidas específicas en cada punto, indicando las distancias entre los diferentes puntos clave del patrón. Las flechas indican la dirección de la base para guiar el corte de la tela. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.ps-5.mt-4 #[b 4. ] En la línea de cintura se identifica un punto con atributo de escalado a 9 cm, este punto determina la medida de separación del busto. #[b Medida de cintura:]
            ul.lista-ul--color.fa-ul.color-primario.ps-5
              li 
                i.fas.fa-plus
        ...
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 6. ] Si la medida de los costados de la pieza del frente y del posterior no coinciden, trace una pinza correctiva de talle. Con la herramienta #[b punto sobre], ubicar un punto a 5 cm por debajo de la altura de la sisa.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta8/imagen6.svg", alt='La imagen detalla una ventana de configuración de atributos de punto en un software de diseño de patrones de costura, junto a un patrón para la parte delantera de una prenda etiquetado como “Base SUPERIOR FRENTE”. La ventana permite ajustar las coordenadas X e Y, la distancia, y el ángulo de un punto específico en el patrón. También se puede seleccionar si el punto es una curva o escalado, y moverlo sobre el contorno. Además, se presentan las posiciones absoluta y proporcional del punto en relación con otros puntos del patrón. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 7. ] Marque una línea guía, exactamente al #[b punto ] de los 5 cm. Con la herramienta punto, fijar ese mismo punto sobre la línea centro frente. Marque una línea guía vertical para identificar el #[b vértice de pinza.]
          .col-md-8
          ...
          .col-md-4.mb-4.mb-md-0
            ...
            ol.lista-ol--cuadro.fa-ol.ps-5
                ...
                li 
                  ...
                  | Traslado al escote.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta8/imagen18.svg", alt='La imagen detalla cinco patrones de la parte delantera de una prenda etiquetada como “Base SUPERIOR FRENTE”. Cada patrón tiene variaciones en las líneas de construcción y las pinzas, indicando diferentes ajustes y modificaciones. Los puntos de referencia en rosa y las líneas de construcción exponen cómo se pueden alterar los patrones para adaptar la prenda.')
        ...
        .tarjeta.borde-redondo.p-4.mb-5(style='background-color: #673AB7')
          .row.justify-content-around.align-items-center
            ...
            .col-sm-12.col-lg-10
              .row.justify-content-between.align-items-center
                .col-sm-12.col-lg-8.mb-sm-0
                  p.mb-0.text-white También se recomienda visitar el siguiente video donde se presenta cómo “aplicar y manipular pinzas en Optitex”.
                .col-sm-12.col-lg-4
    ...
    .tarjeta.tarjeta--gris.p-4.borde-redondo(style="background-color: #F8F5FF")(data-aos="zoom-in-left")
      LineaTiempoC.color-acento-botones(text-small)
        ...
        .row(titulo="7")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 7. ] Tome nuevamente herramienta cortar #[b pieza] (tecla rápida C), y finalizar el corte desde vértice de pinza hasta cintura.
          .col-md-8
        ...
        .row(titulo="10")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 10. ] Repita el ejercicio hasta que no se identifiquen segmentos externos a cada una de las piezas. Al tener la pieza completamente limpia de cualquier segmento, dé clic sobre el punto de vértice o de intersección de pinza y en la pestaña #[b propiedades], opción #[b principal], habilite el #[b atributo curva.]
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta9/imagen10.svg", alt='La imagen presenta una interfaz de software de diseño de patrones de costura. En la parte superior, hay una barra con iconos de diferentes piezas de patrones. En el centro, se exponen dos piezas de patrón: una recta y otra curva, con líneas y puntos de ajuste. A la izquierda, hay un panel de propiedades con opciones seleccionables como “Punto”, “Escalada”, “Curva”, entre otras. ')
        .row(titulo="11")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 11. ] Al asignar el #[b atributo de curva] se modifica toda la pieza.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta9/imagen11.svg", alt='La imagen presenta una interfaz de software de diseño de patrones de costura. En la parte superior, hay una barra con iconos de diferentes piezas de patrón etiquetadas como “Base Sup”. En el centro, se exponen dos piezas de patrón: una recta y otra curva (coloreada en azul), con líneas y puntos de ajuste. A la izquierda, hay un panel de propiedades con opciones como “Principal”, “Escalado”, “Curva”, “Conectado”, y otras.')
        .row(titulo="12")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 12. ] Para evitar modificar todo el trayecto se sugiere agregar punto en ambas direcciones y colocar la medida del trayecto dependiendo del volumen del busto o copa, sin seleccionar ningún atributo.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta9/imagen12.svg", alt='La imagen representa dos capturas de pantalla de una interfaz de software de diseño de patrones de costura. En ambas capturas, se presentan dos piezas de patrón: una recta y otra curva (coloreada en azul). Cada captura tiene una ventana emergente titulada “Atributos de Punto”, donde se pueden ajustar valores como la distancia y el ángulo. Ambas ventanas tienen opciones para “Cerrar”, “Mostrar valor constante”, y campos para ingresar detalles específicos de los puntos. ')
        .row(titulo="13")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 13. ] Al seleccionar el #[b punto de vértice pinza ] y pasar atributo de curva se identifica cómo se suaviza el vértice. Seleccionar herramienta #[b mover punto y suavizar] como se haría de manera manual.
          .col-md-8
        ...
        .row(titulo="15")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 15. ] Repita el mismo ejercicio en cada una de las bases con traslado de pinza para convertir a cortes, recuerde que los nombres comerciales de los cortes varían según la región o el país donde se trabaje, siempre remítase a la parte funcional o técnica de lo que se está trabajando.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta9/imagen15.svg", alt='La imagen presenta cuatro piezas de patrón de costura en una interfaz de software de diseño. Las piezas están etiquetadas como “Blusa CF”, “Blusa Espalda DEL”, “Blusa Espalda”, y “Blusa Espalda Fruncida” (esta última coloreada en azul). Todas las piezas tienen líneas y puntos de ajuste, organizados de manera que parecen partes de un patrón para una blusa.')
    ...
    .row.justify-content-center.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-lg-9
        .bloque-texto-g.color-secundario.p-3.p-sm-4.p-md-5
          .bloque-texto-g__img(
            :style="{'background-image':`url(${require('@/assets/curso/temas/tema1/imagen2.svg')})`}"
          )
    ...
    .tarjeta.tarjeta--azul.p-4.mb-4.borde-redondo(style="background-color: #F8F5FF")(data-aos="zoom-in-left")
      SlyderA(tipo="b")
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 1. ] Para modificar el largo de la prenda, en este caso hasta la altura de cadera; diríjase a #[b caja de herramientas], opción #[b movimiento paralelo. ]
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen1.svg", alt='La imagen representa dos pantallazos de una interfaz de software de diseño de patrones de costura. En la parte izquierda, se presenta una pieza de patrón titulada “Base Sup FRENTE” (coloreada en azul) con líneas y puntos de ajuste, y un panel de herramientas a la izquierda con opciones como “Mover punto”, “Movimiento paralelo”, y “Cortar/Borrar”. A la derecha, se presenta una ampliación de la misma pieza de patrón con más detalle en las líneas y puntos de ajuste. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 2. ] Seleccionar la línea de cintura en sentido de las manecillas del reloj. Cuando el cursor cambia de forma se puede alargar arrastrando el mouse.
          .col-md-8
        ...
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 10. ] Crear cada uno de los puntos de pinza con la herramienta #[b botón], con el fin de poder marcar el ancho de la pinza.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen10.svg", alt='La imagen expone una interfaz de software de diseño de patrones de costura. A la izquierda, se presenta una barra de herramientas con opciones de edición, y una pieza de patrón coloreada en azul con un símbolo de botón agregado. A la derecha, se presenta una pieza de patrón titulada “Base Sup FRENTE” con varios símbolos de botón agregados en diferentes puntos del patrón. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 11. ] Para marcar el largo de la pinza por la línea de cadera utilizar la herramienta #[b punto.]
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen11.svg", alt='La imagen detalla una interfaz de software de diseño de patrones de costura con dos ventanas emergentes tituladas “Atributos de Punto”. Estas ventanas permiten ajustar las coordenadas, distancia, ángulo y proporciones de los puntos en el patrón. En el fondo, se exponen dos piezas de patrón coloreadas en azul con varios símbolos de botón agregados y líneas de ajuste visibles.')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 12. ] Se debe identificar cada uno de los vértices de pinza, teniendo en cuenta que no se puede encontrar el vértice de pinza por costado y el vértice de pinza de ajuste.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen12.svg", alt='La imagen expone dos patrones de costura para la parte delantera de una prenda. Ambos patrones tienen marcados los mismos puntos de referencia y líneas guía, pero el patrón de la izquierda incluye marcas adicionales para la colocación de pinzas, mientras que el patrón de la derecha tiene una marca para un ojal. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 13. ] Para marcar o dibujar la pinza, en la herramienta #[b dibujar], opción #[b borrador] se puede ir marcando cada uno de los puntos o vértices señalados.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen13.svg", alt='La imagen describe dos patrones de costura adicionales para la parte delantera de una prenda. El patrón de la izquierda tiene una línea verde que parece indicar una nueva línea de corte o costura. El patrón de la derecha tiene un diseño con una pinza central que se extiende desde la parte inferior hasta el centro del patrón, además de una marca para un ojal cerca de la parte superior.')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            ...
            p.ps-5 Para alinear los puntos de cintura, en el grupo de herramientas de #[b contorno] seleccione #[b alinear puntos] (tecla rápida G), seleccione los puntos de cintura que se quieren alinear; siempre se debe marcar en el sentido de las manecillas del reloj.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen14.svg", alt='La imagen detalla dos patrones de costura para la parte trasera de una prenda. Ambos patrones tienen marcas de referencia con medidas numéricas en puntos clave. El patrón de la izquierda incluye una línea vertical que puede indicar una costura o pliegue. El patrón de la derecha, que es una versión más pequeña del primero, también tiene una línea vertical similar. Ambos patrones indican que son para la “Base Sub ESPALDA” y exponen opciones de alineación en el software de diseño. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 15. ] En la ventana emergente seleccione #[b alinear al último punto]. En este caso debe seleccionar #[b alinear todos los puntos. ]
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen15.svg", alt='La imagen describe una acción que es: en la ventana emergente, seleccione “Alinear al último punto”. En esta ocasión, debe seleccionar “Alinear todos los puntos”.')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 16. ] En la caja de herramientas escoja #[b movimiento paralelo], seleccione desde el punto de centro atrás hacia costado, en el sentido de las manecillas del reloj; extender hacia abajo, asignando la medida de altura de cadera, teniendo en cuenta el eje X y el eje Y.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen16.svg", alt='En la imagen se describe como en la caja de herramientas, se selecciona la opción de movimiento paralelo. Luego, marque desde el punto central trasero hacia el costado, en sentido de las manecillas del reloj. Extienda hacia abajo, asignando la medida de la altura de la cadera, considerando los ejes X e Y. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 17. ] En este punto ya se tiene la blusa con el largo deseado, es necesario darle la forma de cada uno de los puntos del cuerpo. Para marcar el punto de cintura tome la herramienta #[b puntos sobre] y fije un punto con el atributo de #[b escalado], por costado con la medida de altura de cadera. Para verificar las medidas oprimir la #[b tecla F8. ]
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen17.svg", alt='La imagen detalla tres piezas de un patrón de costura, cada una correspondiente a una parte del cuerpo, probablemente para una prenda superior (como una blusa o chaqueta). Cada pieza tiene medidas específicas y puntos de referencia marcados, que ayudan en la confección y ensamblaje de la prenda.')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 18. ] Verificar el recorrido de la línea de cadera con la herramienta #[b medir]. Aumentar la medida de 1/4 del contorno de cadera más pinza según el manual; en editar segmento de la ventana de #[b medidas], asignar medida, y posteriormente dé clic en el botón #[b aceptar. ]
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen18.svg", alt='La imagen detalla dos ventanas de un software de diseño de patrones, donde se ajustan las dimensiones y divisiones de segmentos del patrón, y una pieza de patrón de costura con medidas y puntos de referencia para confección de una prenda.')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.ps-5.mt-5.mb-5 #[b 19. ] Para marcar la pinza en segmento interno se debe marcar una línea guía en cintura. Con la herramienta #[b punto sobre], fije en el segmento de centro frente, un punto, en el punto de talle o cintura. En el grupo de herramientas #[b insertar ] identifique la herramienta #[b botón], haga clic en #[b crear botón. ] Para marcar el punto de pinza se debe tener en cuenta el primer y segundo lado de pinza, el análisis se hace tomando como referencia el ancho de pinza y la separación del busto.
            p.ps-5 Crear cada uno de los puntos de pinza con la herramienta botón, con el fin de poder marcar el ancho de la pinza. Para marcar el largo de la pinza por línea de cadera utilizar la herramienta punto sobre. Se debe identificar cada uno de los vértices de pinza, teniendo en cuenta que no se puede encontrar el vértice de pinza por costado y el vértice de pinza de ajuste. Para marcar o dibujar la pinza, en la herramienta dibujar, opción borrador se puede ir marcando cada uno de los puntos o vértices señalados.  
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen19.svg", alt='La imagen explica la acción para marcar la pinza en el segmento interno, trace una línea guía en la cintura. Utilice la herramienta de punto sobre para fijar un punto en el segmento del centro frente, en el talle o cintura. En el grupo de herramientas de insertar, seleccione la herramienta botón y cree un botón. Para marcar el punto de pinza, considere los lados de la pinza y analice el ancho de la pinza y la separación del busto. La imagen presenta una ventana del software de diseño de patrones, donde se pueden ajustar las coordenadas (X, Y), la distancia y el ángulo para la colocación de un botón. A la derecha, se presenta un patrón de costura con una pinza marcada en el centro, indicando cómo se aplican las configuraciones del software en el diseño del patrón. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 20. ] Ya en este punto se identifica parte delantera y parte posterior.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen21.svg", alt='La imagen detalla dos piezas de un patrón de costura para la parte delantera y trasera de una prenda. Ambas piezas tienen pinzas marcadas para ajustar el contorno del busto y la cintura, con puntos de referencia y líneas guía que facilitan el ensamblaje y la confección.')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 21. ] Para trazar la pechera o el cruce de botonadura se deben eliminar todos los puntos del centro frente. En el grupo de herramientas #[b editar ] escoja la herramienta #[b extender en paralelo ] y seleccione la #[b línea centro frente ] en el sentido de las manecillas del reloj; en la ventana emergente asigne la medida del cruce de botonadura.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen22.svg", alt='La imagen expone la forma como Para trazar la pechera o el cruce de botonadura, elimine todos los puntos del centro frente. En el grupo de herramientas de edición, seleccione la herramienta de extensión en paralelo y marque la línea del centro frente en el sentido de las manecillas del reloj. En la ventana emergente, asigne la medida del cruce de botonadura.')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 22. ] Al realizar la extensión utilice la herramienta crear un #[b contorno interno paralelo al tramo seleccionado], esta permite crear o extender el cruce de botonadura como se hace de manera manual sobre papel.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta10/imagen23.svg", alt='La imagen detalla la interfaz de un software de diseño de patrones, específicamente en la funcionalidad de crear una línea paralela a un segmento. En la primera ventana emergente, se configuran la distancia y los puntos de extensión de la nueva línea paralela. En la segunda ventana emergente, se pregunta si también se debe crear un punto sobre el contorno extendido. A la derecha, se expone una pieza de patrón con el centro frente y las pinzas marcadas.')
    ...
    .tarjeta.tarjeta--gris.p-4.borde-redondo(style="background-color: #F8F5FF")(data-aos="zoom-in-left")
      LineaTiempoC.color-acento-botones(text-small)
        ...
        .row(titulo="2")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 2. ] Dé clic y verifique que aparece un hilo de tela independiente sobre la pieza que se quiere cortar. De igual manera, se habilita la ventana emergente de costuras, si se desea se puede asignar el margen de costura o en este caso como se viene trabajando, no se asigna margen de costura.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen2.svg", alt='La imagen expone una ventana de configuración del software de diseño de patrones, titulada “Símbolos de Costura”. Aquí se pueden definir los tipos de líneas de costura, el final de las costuras y las cintas de sesgo. A la derecha, se presenta una pieza de patrón con ajustes en las pinzas y otros detalles. La ventana de configuración permite personalizar los símbolos y las líneas que se utilizarán en el diseño del patrón para una mayor precisión en la confección. ')
        .row(titulo="3")
          .col-md-4.mb-4.mb-md-0
            p.ps-5.mb-4 #[b 3. ] Verificar que la pieza se puede trasladar o mover.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen3.svg", alt='La imagen expone la forma como se puede  verificar que la pieza se puede trasladar o mover, para facilitar el proceso.')
        .row(titulo="4")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 4. ] Para poder unir la pieza al posterior se debe validar la medida de los escotes, diríjase al grupo de herramientas #[b insertar], opción #[b voltear pieza] y seleccione #[b volteo horizontal. ]
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen4.svg", alt='La imagen expone la forma como puede  unir la pieza al posterior, primero valide la medida de los escotes. Luego, vaya al grupo de herramientas “Insertar”, seleccione la opción “Voltear pieza” y elija “Volteo horizontal”.')
        .row(titulo="5")
          .col-md-4.mb-4.mb-md-0
            p.ps-5.mb-4 #[b 5. ] Para que coincida hombro con hombro diríjase al grupo de herramientas #[b insertar], opción #[b voltear pieza] y seleccione #[b volteo vertical. ]
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen5.svg", alt='La imagen expone la forma para alinear los hombros, vaya al grupo de herramientas “Insertar”, seleccione la opción “Voltear pieza” y elija “Volteo vertical”. ')
        .row(titulo="6")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 6. ] Para unir las piezas diríjase a la #[b herramienta piezas], opción #[b recorrido]. Haga clic en la pieza que se cortó el delantero y la parte posterior, y haga clic sobre la línea de hombro para unir la pieza.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen6.svg", alt='La imagen expone la forma como debe unir las piezas, vaya a la herramienta “Piezas” y seleccione la opción “Recorrido”. Haga clic en la pieza cortada del delantero y en la parte posterior, luego haga clic en la línea del hombro para unirlas. ')
        .row(titulo="7")
          .col-md-4.mb-4.mb-md-0
            p.ps-5.mb-4 #[b 7. ] Para fusionar las #[b piezas], en el grupo de herramientas piezas seleccione #[b unir piezas o unir partes. ]
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen7.svg", alt='La imagen explica como se debe  unir las piezas, dirígete a la herramienta “Unir piezas”, selecciona la opción “Recorrido”, haz clic en la pieza cortada del delantero y en la parte posterior, y luego haz clic en la línea del hombro. En la ventana emergente “Unir piezas”, configura las opciones necesarias y haz clic en “OK”. ')
        .row(titulo="8")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 8. ] Luego de fusionadas las piezas si no se identifican curvas suaves en cada unión suavice los puntos; tome la herramienta #[b selección], haga clic sobre el punto y asigne atributo #[b curva]. Con la herramienta #[b mover punto] deslice el mouse hasta suavizar la curva. De igual manera, suavice el punto de hombro escote.
          .col-md-8
        ...
        .row(titulo="10")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 10. ] Lo ideal es mover los hilos de tela en tal punto que no interfieran con los cortes que se van a trabajar. Para realizar los cortes, en el grupo de herramientas #[b pieza] seleccione #[b cortar], opción #[b cortar pieza.] Haga clic sobre el punto de hombro, y en la ventana emergente, en la opción #[b proporcional], asignar 0.5 para que quede en la mitad.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen10.svg", alt='La imagen expone una interfaz de software de diseño de patrones, donde se detalla la opción de “Cortar a pica” en el menú superior. Además, se presenta un cuadro de diálogo titulado “Atributos de Punto”, donde se pueden ajustar diversos parámetros como el tipo de punto, las coordenadas X e Y, la distancia, y el ángulo. Estas herramientas permiten realizar ajustes precisos en el diseño del patrón, facilitando la creación y modificación de puntos clave en la pieza. ')
        .row(titulo="11")
          .col-md-4.mb-4.mb-md-0
            p.ps-5.mb-4 #[b 11. ] Vaya al vértice de pinza, posteriormente al primer lado de pinza por cintura, y finalice en el primer lado de pinza por largo total. En la ventana emergente de #[b costura] haga clic en el botón #[b cancelar], identifique el traslado o movimiento del corte.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen11.svg", alt='Para suavizar las uniones, use la herramienta de selección para hacer clic en los puntos de las curvas y asigne el atributo de curva. Luego, con la herramienta de mover puntos, deslice el mouse hasta suavizar las curvas en las uniones, incluyendo el punto del hombro y escote. ')
        .row(titulo="12")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 12. ] Repita el ejercicio hasta generar el corte de costado. Identifique cada una de las piezas, centro, frente, costado y pinza.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen12.svg", alt='La imagen describe como suavizar las uniones, para ello utilice la herramienta de selección para hacer clic en los puntos de las curvas y asigne el atributo de curva. Luego, con la herramienta de mover puntos, deslice el mouse hasta suavizar las curvas en las uniones, incluyendo los puntos en los hombros y escotes. ')
        .row(titulo="13")
          .col-md-4.mb-4.mb-md-0
            p.ps-5.mb-4 #[b 13. ] En la pieza de costado identifique la pinza de recuperación de talle, para cerrar la pinza, en el menú herramientas, opción #[b escalado], seleccione #[b cerrar pinza]. En la ventana emergente #[b fijar pinza] seleccione #[b intermedia entre primer y segundo segmento de pinza.]
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen13.svg", alt='La imagen describe como suavizar las uniones, para ello utilice la herramienta de selección para hacer clic en los puntos de las curvas y asigne el atributo de curva. Luego, con la herramienta de mover puntos, deslice el mouse hasta suavizar las curvas en las uniones, incluyendo los puntos en los hombros y escotes. ')
        .row(titulo="14")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 14. ] Suavice los vértices de pinza en cada uno de los cortes.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen14.svg", alt='La imagen describe dos patrones de costura para una prenda de vestir, probablemente una blusa o una camisa. Cada patrón está coloreado en azul claro y tiene líneas y puntos que indican las líneas de corte y costura. La pieza de la izquierda parece ser la parte delantera del patrón, y la pieza de la derecha, la parte trasera. Ambos patrones tienen flechas y textos que posiblemente indican instrucciones de ensamblaje o alineación.')
        .row(titulo="15")
          .col-md-4.mb-4.mb-md-0
            p.ps-5.mb-4 #[b 15. ] Repita los mismos pasos en la parte posterior para generar el corte princesa en la espalda.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen15.svg", alt='La imagen detalla cuatro patrones de costura para una prenda, con etiquetas y flechas que indican instrucciones de ensamblaje. La cuarta pieza está coloreada en azul claro.')
        .row(titulo="16")
          .col-md-4.mb-4.mb-md-0
            p.ps-5 #[b 16. ] Para generar el corte francés en cualquiera de las dos piezas repita los pasos anteriores, partiendo desde sisa, que es donde sale el corte francés.
          .col-md-8
            img.p-2(src="@/assets/curso/temas/tema1/tarjeta11/imagen16.svg", alt='La imagen detalla dos patrones de costura, uno de los cuales está coloreado en azul claro. Las piezas tienen etiquetas y flechas que indican instrucciones de ensamblaje. ')

    .row.justify-content-center.mt-5.mb-5(data-aos="zoom-in-left")
      .col-sm-12.col-lg-6
        .tarjeta.borde-redondo.p-4.mb-5(style='background-color: #673AB7')
          .row.justify-content-around.align-items-center
            .col-sm-12.col-lg-2.d-none.d-lg-block
    ...
    .tarjeta.tarjeta--azul.p-4.mb-4.borde-redondo(style="background-color: #F8F5FF")(data-aos="zoom-in-left")
      SlyderA(tipo="b")
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 1. ] Para el trazo de tres modelos de falda: falda media campana (página 36), falda con vuelo (página 37) y falda sirena revise en el #[b manual de patronaje SENA (página 34). ]
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen1.svg", alt='La imagen describe una captura de pantalla de un software de diseño de patrones de costura. En la parte superior hay un menú desplegable con opciones relacionadas con pliegues y pinzas. Debajo del menú, se presente un patrón de costura coloreado en azul claro, con una flecha y etiquetas que indican instrucciones de ensamblaje.')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 2. ] Se trabajará la falda de dos pinzas para generar el vuelo hacia el ruedo, cree el primer traslado, tome la herramienta #[b pinza], opción #[b añadir y girar pinza. ]
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen2.svg", alt='La imagen describe tres patrones de costura, todos coloreados en azul claro y etiquetados con instrucciones y flechas para el ensamblaje. Además, hay una ventana emergente de “Atributos de Punto” que parece ser parte del software de diseño de patrones, detalla las opciones para ajustar los detalles de las costuras y las pinzas. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 3. ] Acérquese con el puntero al vértice de pinza, una vez cambie de color dé clic para seleccionarla y #[b arrastre] hasta el ruedo, en el recuadro #[b atributos de punto] proporcione la ubicación deseada del punto al cual se requiera trasladar la pinza.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen3.svg", alt='La imagen expone tres patrones de costura, todos coloreados en azul claro y con etiquetas y flechas que indican instrucciones de ensamblaje. El primer patrón tiene líneas de pinzas en la parte superior. El segundo patrón incluye una línea verde adicional que podría representar una modificación o ajuste. El tercer patrón indica una línea discontinua y una línea verde que indica un posible cambio en el diseño o la posición de alguna parte del patrón. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 4. ] Lleve el puntero a cualquier parte del costado de la falda, haga clic, gire, haga clic y traslade la pinza.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen4.svg", alt='La imagen expone cinco patrones de costura, todos coloreados en azul claro y con etiquetas y flechas que indican instrucciones de ensamblaje. Algunos patrones tienen líneas discontinuas y verdes que indican modificaciones o ajustes en el diseño. En la parte superior central, hay una ventana emergente de “Atributos de Punto” que forma parte del software de diseño, mostrando opciones para ajustar los detalles de las costuras y las pinzas. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 5. ] Se realiza el mismo procedimiento trasladando la otra pinza, una vez cambie de color el vértice de pinza, haga clic para seleccionar y arrastre hasta el ruedo dando clic sobre este, en el recuadro #[b atributos de punto ] indique la #[b ubicación deseada], haga clic en cualquier parte del costado, gire, haga clic y traslade pinza.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen5.svg", alt='La imagen expone cuatro patrones de costura, todos coloreados en azul claro, con etiquetas y flechas que indican instrucciones de ensamblaje. Algunos patrones tienen líneas discontinuas, probablemente para indicar ajustes o pliegues. A la izquierda de la imagen, hay un menú desplegable del software de diseño con varias opciones de herramientas para trabajar con los patrones. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 6. ] Haga clic derecho en la herramienta #[b selección], elija la pinza a eliminar y suprima cada una de las líneas para limpiar la pieza.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen6.svg", alt='La imagen expone dos patrones de costura, ambos coloreados en azul claro y con líneas y puntos que indican detalles de ensamblaje. El patrón de la izquierda tiene una flecha y una línea que podría representar una dirección del grano o una pinza. El patrón de la derecha parece ser una representación ampliada de una sección de un patrón, exponiendo más detalles en los puntos de ajuste o costura. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 7. ] Para suavizar los puntos que se generaron por los traslados de pinza seleccione los puntos en el sentido de las manecillas del reloj, haga clic en el último punto.
          .col-md-8
        ...
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 14. ] Tome la herramienta #[b construir pieza], haga clic sobre la pieza a seleccionar, haga clic para separar la pieza que se desea ampliar o modificar.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen14.svg", alt='La imagen expone tres patrones de costura. El primer patrón a la izquierda está dividido en dos colores: la parte superior en azul claro y la parte inferior en verde, con flechas y líneas que indican instrucciones de ensamblaje. En la parte superior izquierda de la imagen, hay un menú desplegable con opciones como “Definir pieza”, “Definir Tamaño”, “Definir piezas”, “Construir zonas piezas”, y “Definir zonas piezas”. Los otros dos patrones también están coloreados en azul claro, con líneas y flechas similares que indican detalles del ensamblaje. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 15. ] Seleccione en el sentido de las manecillas del reloj dónde se va a dar el vuelo de la pieza. Seleccione en el grupo de herramientas #[b aflojar], opción #[b abrir múltiples flojos] e indique el número de flojos que se quiere trabajar, los flojos corresponden al número de cortes para dar amplitud.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen15.svg", alt='La imagen detalla una captura de pantalla de un software de diseño de patrones. En la parte superior izquierda, hay un menú desplegable con opciones relacionadas con “Ajustar”, incluyendo “Insert Ajuste”, “Abrir Múltiples Ajustes” y “Cerrar Ajuste”. En la parte inferior derecha, hay una ventana emergente titulada “Abrir Pliegues múltiples” que permite al usuario configurar el número de pliegues, el ancho, la posición de los primeros y últimos puntos, y el ángulo de los pliegues. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 16. ] En la ventana emergente, en la sección #[b anchos], defina el rango que se quiere trabajar, #[b desde el inicio hasta el final] de las amplitudes.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen16.svg", alt='La imagen describe  la ventana emergente, en la sección de anchos, donde se define el rango que se desea trabajar, desde el inicio hasta el final de las amplitudes.  ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 17. ] Para suavizar la curva tome los puntos en el sentido de las manecillas del reloj, quite el atributo de #[b escalado ] y asigne atributo de #[b curva.]
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen17.svg", alt='La imagen expone  la forma como se puede  suavizar la curva, en donde debe seleccionar los puntos en el sentido de las manecillas del reloj, eliminar el atributo de escalado y asignar el atributo de curva. ')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 18. ] Repetir el ejercicio para generar más vuelos, las alturas y anchos se pueden modificar.
          .col-md-8
            img.p-3(src="@/assets/curso/temas/tema1/tarjeta12/imagen18.svg", alt='La imagen presenta un software de diseño de patrones de falda. En el centro, hay dos patrones: uno rectangular a la izquierda y dos patrones curvados a la derecha, con el último patrón a la derecha resaltado en azul. En la parte superior, hay íconos de diferentes tipos de patrones de falda.')
        .row.justify-content-center.my-lg-4
          .col-md-4.mb-4.mb-md-0
            p.p-5 #[b 19. ] Para dividir la parte superior de la falda y hacer que coincida con el corte o con el vuelo marque la línea guía a la altura de la separación.
          .col-md-8
