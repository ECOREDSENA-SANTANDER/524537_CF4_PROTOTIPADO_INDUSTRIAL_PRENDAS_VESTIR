...
.curso-main-container.introduccion
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    p.mb-4  En el siguiente video, los aprendices tendrán un acercamiento al contenido del componente, los temas y conceptos tratados y la manera en la que serán abordados.
    ...
    figure
      ...
      figcaption Video. Introducción - #[em Software] Optitex.  
